...
const addHeaderButton = () => {
    ...
    <svg class="bi bi-trash delete-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="17" fill="#0d6efd" viewBox="0 0 16 16">
  ...
  <button class="copy-button" title="Copy" onClick="copyItems()">
    <svg class="bi bi-clipboard I-icon copy-icon" xmlns="http://www.w3.org/2000/svg" width="14" height="17" fill="#0d6efd" viewBox="0 0 16 16">
